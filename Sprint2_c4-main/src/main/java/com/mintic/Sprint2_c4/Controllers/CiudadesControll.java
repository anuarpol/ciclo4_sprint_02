...
import com.mintic.Sprint2_c4.Service.CiudadesIntSer;
...
public class CiudadesControll {
	
	@Autowired
	private CiudadesIntSer service;
	...
	public Ciudades update(@PathVariable Long id, @RequestBody Ciudades ciudades) {
		...
		if (!op.isEmpty()) {
			...
			ciudadesUpdate.setCodigoDane(ciudades.getCodigoDane());
